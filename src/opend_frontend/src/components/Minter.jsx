...
function Minter() {
  ...
  async function onSubmit(data) {
    ...
    const newNFTId = await opend_backend.mint(name, imageByteData);
    console.log(newNFTId.toString());
    setNftPrincipal(newNFTId);
    setLoaderHidden(true);
  }

  //render form if form has not been sent.
  if(nftPrincipal === "") {
    return (
    ...
    return (
      <div className="minter-container">
        ...
        <Button text="See your NFTs" handleClick={location.href='/collection'} />
      </div>
    );
  }
}
