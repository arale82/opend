...
```
dfx canister call opend_backend listItem '(principal "eng72-u4aaa-aaaaa-qaa5q-cai", 2)'
```
...
```
dfx canister call eng72-u4aaa-aaaaa-qaa5q-cai changeOwner '(principal "bw4dl-smaaa-aaaaa-qaacq-cai", true)'
```
